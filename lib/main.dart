      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              width: 150,
              child: Text('Chosse from over 100,000 online video courses'),
            ),
            SizedBox(height: 16),
            TextButton(
              onPressed: () {},
...
class _TopPageState extends State<TopPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    final tween = Tween<Offset>(begin: Offset.zero, end: Offset(-1.0, 0.0));
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SlideTransition(position: _animation4, child: _TrendingCourses())
            ],
          ),
        ),
      )),
